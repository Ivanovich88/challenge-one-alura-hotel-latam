...
public class Busqueda extends JFrame {
		...
		btnEditar.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				if(filaReservas >=0)  {
					...
					limpiarTabla();
					mostrarTablaReservas();
					mostrarTablaHuespedes();//Aqui hay pedo *****************
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				if(filaReservas >= 0  ) {
					...
					int confirmar = JOptionPane.showConfirmDialog(null, "Quiere eliminar la reserva?");
					if (confirmar == JOptionPane.YES_OPTION) {
						...
						limpiarTabla();
						mostrarTablaReservas();  //Aqui puede haber pedo ******************************				}
						mostrarHuespedes();
					}
			} else if(filaHuesped >=0) {
				huespedes = tbHuespedes.getValueAt(filaHuesped,0).toString();
				int confirmarH = JOptionPane.showConfirmDialog(null,"Quiere borrar al huesped de esta reservacion?");
				...
				if(confirmarH == JOptionPane.YES_OPTION) {
					...
					JOptionPane.showMessageDialog(contentPane, "Huesped retirado en el registro!");
					limpiarTabla();
					mostrarHuespedes();
					mostrarTablaReservas();
				}
	...
	private void actualizarHuespedes() {
		...
		},()-> JOptionPane.showInternalMessageDialog(this, "Requiere correccion"));
	}
	...
	private void mostrarTablaHuespedID() {
