...
public class ReservasView extends JFrame {
	...
	*/	
		...
		btnsiguiente.add(lblSiguiente); // Agregamos el JLabel "SIGUIENTE" al panel del botón
	...
	private void guardarReserva() {
		if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() !=null && !txtValor.equals("")
			...
			JOptionPane.showMessageDialog(this, "Favor de completar la informacion");
		}
	}
	
	//Este codigo de calculaciones es alternativo y podria cambiarse.
	
	public void calcularValor(JDateChooser dataE, JDateChooser dataS) {
	    if (dataE.getDate() != null && dataS.getDate() != null) {
	        Date fechaEntrada = dataE.getDate();
	        Date fechaSalida = dataS.getDate();

	        if (fechaEntrada.after(fechaSalida)) {
	            JOptionPane.showMessageDialog(null, "La fecha de entrada no puede ser después de la fecha de salida", "Error en fechas", JOptionPane.ERROR_MESSAGE);
	            return;
	        }
	        ...
	        while (!calEntrada.after(calSalida)) {
	            dias++;
	            calEntrada.add(Calendar.DATE, 1);
	        }

	        int costoPorNoche = 80;
	        int valorTotal = dias * costoPorNoche;
	        txtValor.setText("$" + valorTotal);
	    }
	}

	//Limpieza del valor cuando se actualicen las fechas
